...
def sent_mail(email_from, email_password, email_to, batch_size, start_time, end_time, table_name, batch_no, file_name, date, inserted_rows, status, error_message):
...
<tr>
    ...
    <th style="border:1px solid black; border-collapse: collapse; background-color: #ff8b3d;">ERROR MESSAGE</th>
</tr>
<tr>
    ...
    <th style="border:1px solid black; border-collapse: collapse;">{error_message}</th>
</tr>
</table><br/><br/>
